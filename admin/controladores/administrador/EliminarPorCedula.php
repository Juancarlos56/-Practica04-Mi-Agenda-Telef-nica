<?php
    ...
    echo " <form id='Formulario01' method='POST'  action='../../../../admin/controladores/administrador/EliminarUsuario.php' style='display: inline;'>";
    ...
    if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
            ...
            echo "<br><br>";
            echo "<input type='submit' id='modificar' name='modificar' value='Eliminar'>";
        }
    } else {
