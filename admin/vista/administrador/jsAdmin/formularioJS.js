    ...
    for(var i = 0; i < document.forms[0].elements.length; i++){
        ...
        if(elemento.value == '' && elemento.type == 'text'){
            ...
            case 'rol': 
                ...
                document.getElementById('mensajeRol').innerHTML = 'El campo ROL esta vacio';
                break;
...
function validarROL(elemento){
  
    if((elemento.value.length >= 4)&&(elemento.value.length <=5)){
        if((elemento.value == "admin")||(elemento.value == "user")){
            console.log("rol correcta ");
            document.getElementById('mensajeRol').innerHTML = 'ROL correcta';
            document.getElementById('mensajeRol').style.color = '#00BB2D';
            return true;
        }else{
            elemento.value = "";
            document.getElementById('mensajeRol').innerHTML = 'Datos incorrecta';
            return false;
        }
        
    }else{
        elemento.value = "";
        document.getElementById('mensajeRol').innerHTML = 'ROL incorrecta';
        return false;
